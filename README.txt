...
Brendon Vicente Rocha Silva - 18202189
...
tabulate 0.8.9  - instalação: pip install tabulate
keyboard 0.13.5 - instalação: pip install keyboard


EXECUÇÃO
--------
Para executar o programa, basta utilizar o comando "python3 src/main.py";
